...
public class ClienteDAO implements IDAOT<Cliente>{
    ...
    public String salvar(Cliente o) {
        ...
        try{
            ...
            String sql="insert into cliente (id, nome, endereco, telefone, cpf, pet) "
                    + "values"
                    + "(default, "
                    + "'" + o.getNome() + "', "
                    + "'" + o.getCpf()+ "', "
    ...
    public String excluir(int id) {
        try{
            ...
            System.out.println("Erro ao EXCLUIR CLIENTES!" + e);
            return e.toString();
        }
    }
    ...
    public void popularTabela(JTable tabela, String criterio) {
        ...
        try {
            ...
            while (resultadoQ.next()) {
                ...
                dadosTabela[lin][5] = resultadoQ.getString("pet");
